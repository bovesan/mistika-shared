...
// <ACEStransformID>ACEScsc.ACES_to_ACESproxy12i.a1.0.0</ACEStransformID>
...
)
{
    ...
    rOut = lin_to_ACESproxy( ACESproxy_lin[0], StepsPerStop, MidCVoffset, CVmin, CVmax) / 4095.0;
    gOut = lin_to_ACESproxy( ACESproxy_lin[1], StepsPerStop, MidCVoffset, CVmin, CVmax) / 4095.0;
    bOut = lin_to_ACESproxy( ACESproxy_lin[2], StepsPerStop, MidCVoffset, CVmin, CVmax) / 4095.0;
    aOut = aIn;
}
