...
// <ACEStransformID>ACEScsc.ACESproxy12i_to_ACES.a1.0.0</ACEStransformID>
...
{
    float AP1_lin[3];
    AP1_lin[0] = ACESproxy_to_lin( rIn * 4095.0, StepsPerStop, MidCVoffset, CVmin, CVmax);
    AP1_lin[1] = ACESproxy_to_lin( gIn * 4095.0, StepsPerStop, MidCVoffset, CVmin, CVmax);
    AP1_lin[2] = ACESproxy_to_lin( bIn * 4095.0, StepsPerStop, MidCVoffset, CVmin, CVmax);
