...
uniform vec3 param2;
float adskUID_Speed = float(param2.x) * 0.01;
float adskUID_Offset = float(param2.y) * 0.01;
uniform vec3 param1;
float adskUID_amount = float(param1.x) * 0.01;
float adskUID_size = float(param1.y) * 0.01;
uniform vec3 param4;
float adskUID_max_rad = float(param4.x) * 1.0;
uniform vec3 param5;
vec3 adskUID_speed = vec3(param4.y, param4.z, param5.x) * 0.01;
float adskUID_bias_adj = float(param1.z) * 0.01;
uniform vec3 param3;
int adskUID_blendModes = int(param3.z);
int adskUID_style = int(param5.y);
