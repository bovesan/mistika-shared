...
vec2 paramPos = vec2(param5.y, param5.z) * 0.01;
uniform vec3 param4;
float paramSpeed = float(param4.z) * 0.01;
uniform vec3 param6;
bool paramProcedural = bool(param6.x);

// Added for Action camera 
uniform vec3 param7;
vec3 camera_position = vec3(param6.y, param6.z, param7.x) * 0.01;
uniform vec3 param8;
vec3 camera_interest = vec3(param7.y, param7.z, param8.x) * 0.01;
uniform vec3 param2;
float camera_roll = float(param2.z) * 0.01;
float camera_fov = float(param4.y) * 0.01;
uniform vec3 param3;
