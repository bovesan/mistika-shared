...
uniform vec3 param3;
float paramFlameSpeed = float(param3.x) * 0.01;
vec2 paramFlameDirection = vec2(param4.y, param4.z) * 0.01;
uniform vec3 param5;
vec3 paramColor1 = vec3(param5.x, param5.y, param5.z) * 0.01;
uniform vec3 param6;
vec3 paramColor2 = vec3(param6.x, param6.y, param6.z) * 0.01;
