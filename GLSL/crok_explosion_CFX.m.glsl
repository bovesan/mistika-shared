...
uniform vec3 param1;
int steps = int(param1.x);
int detail = int(param1.y);
...
uniform vec3 param5;
vec3 lightColor = vec3(param4.z, param5.x, param5.y) * 0.01;
uniform vec3 param6;
vec3 sphere_center = vec3(param5.z, param6.x, param6.y) * 1.0;
...
void main( void )
{
   ...
   float depth = texture2DRect(image2, res * uv).x;
