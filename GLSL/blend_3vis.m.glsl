...
uniform vec3 param1;
bool idarken = bool(param1.y);
bool imultiply = bool(param1.x);
uniform vec3 param9;
bool icolorBurn = bool(param9.x);
uniform vec3 param6;
bool ilinearBurn = bool(param6.y);
uniform vec3 param5;
bool idarkerColor = bool(param5.z);
uniform vec3 param2;
bool ilighten = bool(param2.y);
uniform vec3 param4;
bool iscreen = bool(param4.z);
bool icolorDodge = bool(param2.z);
bool ilinearDodge = bool(param2.x);
uniform vec3 param8;
bool ilighterColor = bool(param8.z);
bool ioverlay = bool(param6.x);
bool isoftLight = bool(param5.x);
uniform vec3 param3;
bool ihardLight = bool(param3.z);
bool ivividLight = bool(param8.y);
bool ilinearLight = bool(param5.y);
bool ipinLight = bool(param1.z);
bool ihardMix = bool(param8.x);
bool idifference = bool(param4.x);
bool iexclusion = bool(param4.y);
bool isubstract = bool(param3.x);
uniform vec3 param7;
bool idivide = bool(param7.x);
bool ihue = bool(param7.z);
bool icolor = bool(param6.z);
bool isaturation = bool(param3.y);
bool iluminosity = bool(param7.y);
