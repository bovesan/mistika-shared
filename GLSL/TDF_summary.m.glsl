...
uniform vec3 param7;
float adsk_time = float(param7.z) * 1.0;
vec2 res = gl_TexCoord[0].zw;
float adsk_result_w = res.x;
float adsk_result_h = res.y;
uniform vec3 param1;
int Demo = int(param1.x);
uniform vec3 param8;
int Preset = int(param8.x);
float speed = float(param1.y) * 0.01;
float offset = float(param1.z) * 0.01;
float pp1 = float(param8.y) * 1.0;
float pp2 = float(param8.z) * 1.0;
uniform vec3 param9;
float pp3 = float(param9.x) * 1.0;

uniform vec3 param2;
float glitch_pp1 = float(param2.z) * 0.01;
uniform vec3 param3;
float glitch_pp2 = float(param3.x) * 0.01;
float glitch_pp3; = float(param9.y) * 1.0;
float uniform = float(param9.z) * 1.0;
uniform vec3 param10;
float int = float(param10.x) * 1.0;
float glitch_pp4 = float(param3.z) * 1.0;
uniform vec3 param4;
float caress_pp1 = float(param4.x) * 0.01;
float caress_pp2 = float(param4.y) * 0.01;
float caress_pp3; = float(param10.y) * 1.0;
float uniform = float(param9.z) * 1.0;
float int = float(param10.x) * 1.0;
uniform vec3 param5;
float caress_pp4 = float(param5.x) * 1.0;
float lins_pp1 = float(param10.z) * 1.0;
uniform vec3 param11;
float lins_pp2 = float(param11.x) * 1.0;
float lins_pp3; = float(param11.y) * 1.0;
float uniform = float(param9.z) * 1.0;
float int = float(param10.x) * 1.0;
float lins_pp4 = float(param11.z) * 1.0;
float geomshape_pp1 = float(param5.y) * 0.01;
float geomshape_pp2 = float(param5.z) * 0.01;
uniform vec3 param12;
float geomshape_pp3; = float(param12.x) * 1.0;
float uniform = float(param9.z) * 1.0;
float int = float(param10.x) * 1.0;
uniform vec3 param6;
float geomshape_pp4 = float(param6.y) * 1.0;
float lemonade_pp1 = float(param6.z) * 0.01;
float lemonade_pp2 = float(param12.y) * 1.0;
float lemonade_pp3; = float(param12.z) * 1.0;
float uniform = float(param9.z) * 1.0;
float int = float(param10.x) * 1.0;
uniform vec3 param13;
float lemonade_pp4 = float(param13.x) * 1.0;
float tdf4_pp1 = float(param13.y) * 1.0;
float tdf4_pp2 = float(param13.z) * 1.0;
uniform vec3 param14;
float tdf4_pp3; = float(param14.x) * 1.0;
float uniform = float(param9.z) * 1.0;
float int = float(param10.x) * 1.0;
float tdf4_pp4 = float(param14.y) * 1.0;
float glowart_pp1 = float(param14.z) * 1.0;
uniform vec3 param15;
float glowart_pp2 = float(param15.x) * 1.0;
float glowart_pp3; = float(param15.y) * 1.0;
float uniform = float(param9.z) * 1.0;
float int = float(param10.x) * 1.0;
float glowart_pp4 = float(param15.z) * 1.0;
float flash_pp1 = float(param7.x) * 0.01;
uniform vec3 param16;
float flash_pp2 = float(param16.x) * 1.0;
float flash_pp3; = float(param16.y) * 1.0;
float uniform = float(param9.z) * 1.0;
float int = float(param10.x) * 1.0;
float flash_pp4 = float(param7.y) * 1.0;
    
uniform vec3 param17;
vec2 center = vec2(param16.z, param17.x) * 0.01;
